<template>
  <footer class="bg-brown-700 text-white py-8">
    <div class="container mx-auto px-4 text-center">
      ...
      <div class="inline-flex items-center justify-center mt-4 py-2 px-4 rounded-lg bg-brown-800 text-sm opacity-80 hover:opacity-100 transition-all">
        <span class="mr-2">Created by</span>
        <div class="flex items-center gap-3">
          <a href="https://www.linkedin.com/in/matheuzsr/" target="_blank" class="flex items-center gap-1 hover:text-blue-300 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
              <path d="M19 3a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h14m-.5 15.5v-5.3a3.26 3.26 0 00-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 011.4 1.4v4.93h2.79M6.88 8.56a1.68 1.68 0 001.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 00-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z"/>
            </svg>
            <span class="hover:underline">/matheuzsr</span>
          </a>
          <a href="https://github.com/matheuzsr" target="_blank" class="flex items-center gap-1 hover:text-gray-300 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
